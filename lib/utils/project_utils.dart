class ProjectUtils {
  static const List<String> banners = [
    "assets/projects/entera_verseW.png",
  ...
  static const List<String> icons = [
    "assets/projects/entera_verse.png",
  ...
  static const List<String> description = [
    "An entertainment application and website made with flutter(Bloc and Cubits State Management is used).AWS S3 bucket to store data",
  ...
  static const List<String> links = [
    "https://github.com/DivyanshMandhan/Entera-Verse",
